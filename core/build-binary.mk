...
all_source_extensions := .c .s .S .asm $(LOCAL_CPP_EXTENSION) $(LOCAL_RS_EXTENSION) .f .f90 .f95
else
all_source_extensions := .c .s .S $(LOCAL_CPP_EXTENSION) $(LOCAL_RS_EXTENSION) .f .f90 .f95
endif
...
# handle free-form Fortran (.f95)
$(foreach src,$(filter %.f95,$(LOCAL_SRC_FILES)), $(call compile-f95-source,$(src)))
