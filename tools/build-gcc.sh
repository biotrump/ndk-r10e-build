...
#fortran
#EXTRA_CONFIG_FLAGS="--disable-bootstrap --disable-libquadmath --disable-libquadmath-support  --disable-plugin"
EXTRA_CONFIG_FLAGS="--disable-bootstrap --disable-libquadmath --disable-libquadmath-support"
...
if [ "$HOST_OS" = "linux" ]; then
    ...
    $ANDROID_NDK_ROOT/build/tools/check-glibc.sh -v $NDK_DIR/$SUBDIR
fi
